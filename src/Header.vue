<template>
  ...
  >
    ...
    <div class="flex items-center">
      ...
      <ul class="relative hidden gap-10 text-white md:z-50 md:flex md:items-center">
  ...
  <Transition name="slide">
    <div
      class="fixed right-0 top-0 z-50 h-72 w-full overflow-x-hidden bg-white shadow-2xl md:hidden"
      v-show="!isHidden"
    >
      ...
      >
        <div class="flex w-32 flex-col gap-3">
          <li class="border-b-2 border-primary" @click="isHidden = !isHidden">
            <a class="text-lg" href="#Skills">{{ language.translatedText.nav.skill }}</a>
          </li>
          <li class="border-b-2 border-primary" @click="isHidden = !isHidden">
            <a class="text-lg" href="#Projects">{{ language.translatedText.nav.projects }}</a>
          </li>
          <li class="border-b-2 border-primary" @click="isHidden = !isHidden">
            <a class="text-lg" href="#Contact">{{ language.translatedText.nav.contact }}</a>
          </li>
...
const currentLanguage = computed(() => language.currentLanguage);
